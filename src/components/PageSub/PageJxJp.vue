        ...
        <div class="lazy-bot">
            <div class="lazy-bot-left">
                <div class="lazy-bot-left-cons">
                    <div class="lazy-bot-left-item" v-for="item in JpLazyLeftList" :key="item.id" @click="btnxq('detail')">
            ...
            <div class="lazy-bot-right">
                <div class="lazy-bot-right-cons">
                    <div class="lazy-bot-right-item" v-for="item in JpLazyRightList" :key="item.id" @click="btnxq('detail')">
...
export default {
 data() {
    ...
    created(){
        ...
        xhr.send();
        xhr.onload = function () {
            that.JpLazyLeftList = JSON.parse(xhr.response).JpLazyLeftList;
        ...
        xhr1.onload = function () {
            that.JpLazyRightList = JSON.parse(xhr1.response).JpLazyRightList;
