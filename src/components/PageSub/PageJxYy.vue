        ...
        <div class="lazy-bot">
            <div class="lazy-bot-left">
                <div class="lazy-bot-left-cons">
                    <div class="lazy-bot-left-item" v-for="item in YyLazyLeftList" :key="item.id"  @click="btnxq('detail')">
            ...
            <div class="lazy-bot-right">
                <div class="lazy-bot-right-cons">
                    <div class="lazy-bot-right-item" v-for="item in YyLazyRightList" :key="item.id"  @click="btnxq('detail')">
 ...
 data() {
    ...
    created(){
        ...
        xhr5.onload = function () {
            that.YyLazyLeftList = JSON.parse(xhr5.response).YyLazyLeftList;
        ...
        xhr6.onload = function () {
            that.YyLazyRightList = JSON.parse(xhr6.response).YyLazyRightList;
