        ...
        <div class="lazy-bot">
            <div class="lazy-bot-left">
                <div class="lazy-bot-left-cons">
                    <div class="lazy-bot-left-item" v-for="item in BkLazyLeftList" :key="item.id"  @click="btnxq('detail')">
            ...
            <div class="lazy-bot-right">
                <div class="lazy-bot-right-cons">
                    <div class="lazy-bot-right-item" v-for="item in BkLazyRightList" :key="item.id"  @click="btnxq('detail')">
...
export default {
  data() {
    ...
    created(){
        ...
        xhr.send();
        xhr.onload = function () {
            that.BkLazyLeftList = JSON.parse(xhr.response).BkLazyLeftList;
        ...
        xhr1.onload = function () {
            that.BkLazyRightList = JSON.parse(xhr1.response).BkLazyRightList;
