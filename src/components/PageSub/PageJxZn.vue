        ...
        <div class="lazy-bot">
            <div class="lazy-bot-left">
                <div class="lazy-bot-left-cons">
                    <div class="lazy-bot-left-item" v-for="item in ZnLazyLeftList" :key="item.id" @click="btnxq('detail')">
            ...
            <div class="lazy-bot-right">
                <div class="lazy-bot-right-cons">
                    <div class="lazy-bot-right-item" v-for="item in ZnLazyRightList" :key="item.id" @click="btnxq('detail')">
...
export default {
   data() {
    ...
    created(){
        ...
        xhr.send();
        xhr.onload = function () {
            that.ZnLazyLeftList = JSON.parse(xhr.response).ZnLazyLeftList;
        ...
        xhr1.onload = function () {
            that.ZnLazyRightList = JSON.parse(xhr1.response).ZnLazyRightList;
